# 2026-01-21 - Step Plan V2（Home UIUX + Gallery Hero/Hotspots + Hamburger Nav v2）(Archive)
...
- What shipped: PR-9..PR-12（permalink canonical、admin preview links canonical、永久 redirects + legacy 清理、comments UI folder 內聚化）
