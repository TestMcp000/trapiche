...
| [ai-analysis-spec.md](completed/ai-analysis-spec.md) | Spec | Stable | 2026-01-04 | AI Analysis Spec（Admin-only） |
...
| [import-export-spec.md](completed/import-export-spec.md) | Spec | Stable | 2026-01-02 | Import/Export (Admin-only) — Technical Spec |
...
| [payments-initiation-spec.md](proposed/payments-initiation-spec.md) | Spec | DRAFT | 2026-01-03 | Payments Initiation Spec（Stripe / LINE Pay / ECPay） |
