...
| [GALLERY_HERO_IMAGE_AND_HOTSPOTS.md](proposed/GALLERY_HERO_IMAGE_AND_HOTSPOTS.md) | PRD | Draft | 2026-01-29 | Home（UIUX 跟稿）+ Gallery Hero Image + Image Hotspots（圖上 Pin）- Product Requirements Document (PRD) |
